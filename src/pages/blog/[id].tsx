...
import Blogphoto from '../../public/blog-details1.jpg'
import Blogphoto1 from '../../public/blog-sm-5.jpg'
import Blogphoto2 from '../../public/blog-big-4.jpg'
import Icon, { IconsType } from '../../components/lib/Icon'
...
const BlogDetails = () => {
  ...
  return (
    <Layout title={'Blog'} className={'bg-gray-100 min-h-screen'}>
      <div className='container flex my-10 mx-auto max-sm:flex-col max-sm:my-0 max-sm:mx-auto max-sm:px-4  sm:flex-col  md:flex-row justify-between mt-14 pt-24'>
        <div className='container max-sm:w-full  main w-4/6'>
          ...
          <div className='content'>
            <p className='my-9'>
              One in four people in the world will be affected by mental or neurological disorders
              at some point in their lives, says the World Health Organization. Still, we spend more
              time brushing our teeth than taking care of our mental health, said Guy Winch in his
              TED talk.
            </p>
            <p className='my-9'>
              One in four people in the world will be affected by mental or neurological disorders
